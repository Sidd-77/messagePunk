    ...
    <div className="bg-gray-50 min-h-screen flex flex-col justify-between">
      ...
      <header className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-24">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-4 text-lg">
            End-to-end encryption, real-time messaging, and group
            chat—everything you need in a secure chat app.
          </p>
          <div className="mt-8">
            <Button
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-gray-600">
                Access your messages on any device, securely and seamlessly.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-gray-600">
                Collaborate easily with groups and share files, messages, and
                more.
              </p>
            </div>
          </div>
      ...
      <section className="bg-blue-600 text-white py-16">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-4">
            Experience secure, real-time communication with MessagePunk.
          </p>
          <div className="mt-8">
            <Button
              className="px-6 py-3 text-lg font-semibold bg-white text-blue-600"
              variant={"default"}
            >
              Join Now
            </Button>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto text-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} MessagePunk. All Rights Reserved.
          </p>
        </div>
      </footer>
    </div>
