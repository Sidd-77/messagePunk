...
export class NotificationQueue {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      console.log(`Connected to RabbitMQ and waiting for notifications in ${this.QUEUE_NAME}`);
    } catch (error) {
  ...
  async consumeNotifications(callback: (message: any) => Promise<void> | void): Promise<void> {
    try {
